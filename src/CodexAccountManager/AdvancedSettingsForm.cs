...
public sealed class AdvancedSettingsForm : Form
{
    ...
    {
        Theme.SetupDialog(this, "Cài đặt nâng cao", new Size(580, 340));
        ...
        layout.Controls.Add(Theme.Label("Codex Home gốc"), 0, 0); layout.Controls.Add(home, 0, 1);
        layout.Controls.Add(Theme.Label("Thư mục làm việc"), 0, 2); layout.Controls.Add(workingDirectory, 0, 3);
        layout.Controls.Add(new TextBox { Text = "Codex: " + (dependencies.Codex ?? "Không tìm thấy"), ReadOnly = true, BorderStyle = BorderStyle.None, Dock = DockStyle.Fill, BackColor = Theme.Background }, 0, 4);
        layout.Controls.Add(new TextBox { Text = "PowerShell: " + (dependencies.PowerShell ?? "Không tìm thấy"), ReadOnly = true, BorderStyle = BorderStyle.None, Dock = DockStyle.Fill, BackColor = Theme.Background }, 0, 5);
        var download = new LinkLabel { Text = "Tải .NET 8 Desktop Runtime · Windows x64", AutoSize = true, LinkColor = Theme.Accent };
        download.LinkClicked += (_, _) =>
        {
            ...
            catch (Exception) { MessageBox.Show(this, "Không mở được trình duyệt. Truy cập dotnet.microsoft.com/download/dotnet/8.0."); }
        };
        layout.Controls.Add(download, 0, 6);
        var actions = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.RightToLeft, WrapContents = false };
        var save = Theme.Button("Lưu", true); save.DialogResult = DialogResult.OK;
